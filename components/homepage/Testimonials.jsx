...
export default function Testimonials({ testimonialsData }) {
    ...
    return (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', background: '#252d35', padding: '4% 0' }}>
            <Image src="/images/Google-Reviews.png" alt="Google Reviews" style={{height:70}} height={70} width={200}/>
            <Title 
                ...
                >
                    {testimonialsData.map((item, i) => (
                        <SwiperSlide
                            ...
                            <div>
                                <Image src="/images/curve.svg" alt='curve' style={{ marginTop: -3, height: 40, position: 'absolute' }} height={40} width={10}/>
