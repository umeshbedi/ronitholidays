      ...
      <div style={{ padding: "10px 5%", background: '#10263b', color: 'grey' }}>
        ...
        <div style={{ display: 'flex', justifyContent: "space-between", flexDirection:isMobile?"column":'row', gap:10 }}>
          <div style={{ display: 'flex', gap: isMobile?5:15, justifyContent:isMobile?"space-between":"flex-start" }}>
            <Image src="/payment/visa.png" alt="Visa" style={{ height: 20 }}  height={20} width={50}/>
            <Image src="/payment/maestro.png" alt="Visa" style={{ height: 20 }}  height={20} width={50}/>
            <Image src="/payment/rupay.png" alt="rupay" style={{ height: 20 }}  height={20} width={50}/>
            <Image src="/payment/upi.png" alt="UPI" style={{ height: 20 }} height={20} width={50} />
            <Image src="/payment/no-cost-emi.png" alt="no-cost-emi" style={{ height: 20 }}  height={20} width={50}/>

          </div>

          <div style={{ display: 'flex', gap: isMobile?3:15 }}>
            <Image src="/payment/secure.png" alt="secure payment" style={{ height: 20 }} height={20} width={50} />
            <Image src="/payment/encrypt.png" alt="Visa" style={{ height: 20 }} height={20} width={50} />
            <Image src="/payment/razorpay.png" alt="razorpay" style={{ height: 20, background: 'grey' }}  height={20} width={50}/>
          </div>
        </div>
      </div>
