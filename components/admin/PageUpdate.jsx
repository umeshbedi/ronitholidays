...
export default function PageUpdate({ pageName }) {
    ...
    function Submit() {
        ...
        db.collection('pages').doc(`${pageName}`).update({
            title, headerImage, metaDescription,metaKeywords,metaTitle, about 
        }).then((e) => {
        ...
        db.collection('pages').doc(`${pageName}`).get()
            .then((snap) => {
                ...
                if (dataLength!=0) {
                    ...
                    metaKeyRef.current.value = data.metaKeywords
                    metaTitRef.current.value = data.metaTitle
        ...
        <div>
            ...
            <Form>
                ...
                <Form.Item label="Meta Title">
                    <input ref={metaTitRef} defaultValue={metaTitle} placeholder='Enter Meta Title' onChange={(e)=>setMetaTitle(e.target.value)}/>
                </Form.Item>
                <Form.Item label="Meta Description">
                    <input ref={metaDescriptionRef} defaultValue={metaDescription} placeholder='Enter Meta Description' onChange={(e)=>setmetaDescription(e.target.value)}/>
                </Form.Item>
                <Form.Item label="Meta Keywords">
                    <input ref={metaKeyRef} defaultValue={metaKeywords} placeholder='Enter Meta Keywords' onChange={(e)=>setMetaKeywords(e.target.value)}/>
                </Form.Item>
