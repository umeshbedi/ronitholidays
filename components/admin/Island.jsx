...
export default function Island() {
    ...
    var metaKeywordsRef = useRef(null)
    var metaTitleRef = useRef(null)
    ...
    function editIsland() {
        Islanddb.doc(`${selectedIsland}`).update({
            name, order, metaDescription, headerImage, thumbnail ,metaTitle,metaKeywords
        }).then(() => {
            msg.success("Updated")
            setname("")
            setthumbnail("")
    ...
    function updatePlace(name, about, metaDescription, metaTitle,metaKeywords, thumbnail) {
        const tempSIPD = SID.data
        const editedPlace = {
            about, metaDescription, metaKeywords, metaTitle, name, thumbnail,
        ...
        <div>
                        ...
                        <Space>
                            <Button type='dashed'
                                ...
                                onClick={() => {
                                    ...
                                    setMetaKeywords(SID.metaKeywords)
                                    setMetaTitle(SID.metaTitle)
                                    setOrder(SID.order)
                                    setTimeout(() => {
                                        ...
                                        metaKeywordsRef.current.value = SID.metaKeywords;
                                        metaTitleRef.current.value = SID.metaTitle;
                                    }, 100);
            ...
            >
                <div style={{ flexDirection: 'column', display: 'flex', gap: 10, padding: '1%' }}>
                    ...
                    <div>Meta Title:
                        <input ref={metaTitleRef} placeholder='Enter Meta Title' onChange={(e) => setMetaTitle(e.target.value)} />
                    </div>
                    <div>Meta Description:
                        <input ref={metaDescriptionRef} placeholder='Enter Meta Description' onChange={(e) => setMetaDescription(e.target.value)} />
                    </div>
                    <div>Meta Keywords:
                        <input ref={metaKeywordsRef} placeholder='Enter Meta Keywords' onChange={(e) => setMetaKeywords(e.target.value)} />
                    </div>
