...
export default function AddactivityDetails({ details, activityId, addNew }) {
    ...
    useEffect(() => {
        if (details != null) {
            ...
            setMetaKeywords(details.metaKeywords)
    ...
    function updateActivity() {
        activitydb.doc(`${details.id}`).update({ name, thumbnail, headerImage, metaDescription, metaTitle, metaKeywords, order, data, about })
            .then(() => { msg.success("Added new activity Succussfully!") })
    }
        ...
        <div style={{ marginTop: '2%', flexDirection: 'column', display: 'flex', gap: 20 }}>
            ...
            <Form>
                ...
                <Form.Item label="Meta Title">
                    <input required defaultValue={metaTitle} placeholder='Enter Meta Title' onChange={(e) => setMetaTitle(e.target.value)} />
                </Form.Item>
                ...
                <Form.Item label="Meta Keywords">
                    <input required defaultValue={metaKeywords} placeholder='Enter Meta Keywords' onChange={(e) => setMetaKeywords(e.target.value)} />
                </Form.Item>
            </Form>
            <Divider />
            <div>
